...
function generateDistinctColors(count) {
    ...
    for (let i = 0; i < count; i++) {
        const hue = i / count;  // Spread hues evenly across the spectrum
        const saturation = 0.7; // Moderate saturation to avoid overly bright or dull colors
        const lightness = 0.7;  // Higher lightness to avoid dark colors
